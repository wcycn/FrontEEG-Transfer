#!/usr/bin/env python3
"""Run all strict participant-held-out ds007169 FrontEEGNet folds."""
...
from fronteeg_transfer.external_ds007169 import discover_recordings
...
def run_target(args: argparse.Namespace, target: str, gpu: int) -> str:
    ...
    command = [
        sys.executable,
        str(Path(__file__).with_name("run_ds007169_eegnet_subject.py")),
        "--raw-root",
...
def main() -> None:
    ...
    subjects = sorted(discover_recordings(raw_root))
    if len(subjects) != 18:
